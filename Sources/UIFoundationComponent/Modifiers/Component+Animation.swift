...
public typealias AnimatorWrapperComponent<Content: Component> = ModifierComponent<Content, AnimatorWrapperRenderNode<Content.ResultRenderNode>>
...
extension Component {
    ...
    public func animateUpdateIf(
        ...
        _ updateBlock: @escaping ((NSUIView, NSUIView, CGRect) -> Void)
    ) -> some Component {
