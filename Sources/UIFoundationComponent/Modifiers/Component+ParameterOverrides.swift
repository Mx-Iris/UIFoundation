...
public typealias IDComponent<Content: Component> = ModifierComponent<Content, ContextOverrideRenderNode<Content.ResultRenderNode>>

/// A component produced by the ``Component/animator(_:)`` modifier
public typealias AnimatorComponent<Content: Component> = ModifierComponent<Content, ContextOverrideRenderNode<Content.ResultRenderNode>>

/// A component produced by the ``Component/reuseKey(_:)`` modifier
public typealias ReuseKeyComponent<Content: Component> = ModifierComponent<Content, ContextOverrideRenderNode<Content.ResultRenderNode>>
