...
final class ComponentViewDiffApplier {
    private struct Context {
        ...
        let oldViews: [NSUIView]
        let newRenderables: [Renderable]
        let hostingView: NSUIView
        let containerView: NSUIView
    ...
    static func apply(
        ...
        var newViews = [NSUIView?](repeating: nil, count: context.newRenderables.count)
        applyActions(
            actions: diffActions,
            into: &newViews,
            context: context
