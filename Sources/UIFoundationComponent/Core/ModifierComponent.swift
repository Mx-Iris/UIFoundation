...
public struct ModifierComponent<Content: Component, Result: RenderNode>: Component where Content.ResultRenderNode.View == Result.View {
    ...
    public let modifier: (Content.ResultRenderNode) -> Result
    ...
    public init(content: Content, modifier: @escaping (Content.ResultRenderNode) -> Result) {
