...
open class StatusItemController: NSObject, NSMenuDelegate {
    ...
    public func openMenu() {
        // Yes, `popUpMenu(_:)` is deprecated, however there seems to be a bug in AppKit.
        // Without using this method, the menu does not pop up immediately,
        // and you have to click a second time.
    ...
    private func _didClickStatusItem(_ sender: NSStatusItem) {
        if NSApp.isCurrentEventRightClickUpForStatusItem {
