...
extension CGKeyCode {
    ...
    fileprivate static let downArrow: Self = 125
    fileprivate static let upArrow: Self = 126
}
...
extension NSMenu {
    fileprivate static let defaultFont = NSMenu().font
    fileprivate var recursiveFont: NSFont { font == Self.defaultFont ? supermenu?.recursiveFont ?? font : font }
}
