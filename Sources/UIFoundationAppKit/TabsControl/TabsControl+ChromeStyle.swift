...
extension TabsControl {
    public struct ChromeStyle: ThemedStyle {
        ...
        public func titleRect(title: NSAttributedString, inBounds rect: NSRect, showingIcon: Bool, showingMenu: Bool, closePosition: ClosePosition?) -> NSRect {
            let paddedHeight = PaddedHeight.fromFrame(rect)
            // Left border is angled at 45˚, so it grows proportionally wider.
        ...
        public func titleEditorSettings() -> TitleEditorSettings {
            return (textColor: theme.tabButtonTheme.titleColor,
                    font: theme.tabButtonTheme.titleFont,
                    alignment: Defaults.alignment)
        }

        public func attributedTitle(content: String, selectionState: SelectionState) -> NSAttributedString {
        ...
        fileprivate enum PaddedHeight {
            ...
            static func fromFrame(_ frame: NSRect) -> PaddedHeight {
                ...
                // Chrome tabs have lots of whitespace to the top; if that's too cramped, skip the effect.
            ...
            var topPadding: CGFloat {
                ...
                case let .padded(height, originalHeight):
                    // Visual distance to top control border.
        ...
        fileprivate func drawBottomBorder(frame: NSRect) {
            ...
            theme.tabsControlTheme.borderColor.setFill()
            bottomBorder.fill()
        }
