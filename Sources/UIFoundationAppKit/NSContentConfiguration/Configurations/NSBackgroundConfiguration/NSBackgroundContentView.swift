...
public class NSBackgroundView: NSView, NSContentView {
    ...
    public override func layout() {
        ...
        contentView.frame.size.width = frame.size.width - appliedConfiguration.insets.box.width
        contentView.frame.size.height = frame.size.height - appliedConfiguration.insets.box.height
        contentView.clipsToBounds = false
