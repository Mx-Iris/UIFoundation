...
extension NSContentUnavailableConfiguration {
    ...
    public struct ButtonConfiguration {
        ...
        public enum Size: Hashable {
            ...
            var size: CGSize? {
                switch self {
                case let .fixed(size): return size
                default: return nil
                }
            }
        ...
        public static func symbolImageButton(_ symbolName: String, symbolConfiguration: ImageSymbolConfiguration? = nil, style: Style = .bordered, action: @escaping (() -> Void)) -> Self {
            Self(image: NSImage(systemSymbolName: symbolName, accessibilityDescription: nil), style: style, symbolConfiguration: symbolConfiguration, action: action)
        }
    }
}
...
@available(macOS 12.0, *)
extension NSContentUnavailableConfiguration.ButtonConfiguration {
