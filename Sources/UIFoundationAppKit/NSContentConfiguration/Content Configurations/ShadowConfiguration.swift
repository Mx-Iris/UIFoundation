...
//    @ViewBuilder
//    public func shadow(_ configuration: ShadowConfiguration) -> some View {
...
//    public static func inner(_ configuration: ShadowConfiguration) -> ShadowStyle {
...
//    public static func drop(_ configuration: ShadowConfiguration) -> ShadowStyle {
...
//    public func shadowConfiguration(_ configuration: ShadowConfiguration) -> some ShapeStyle {
...
//    /// - Parameters:
//    ///   - configuration:The configuration for configurating the apperance.
//    public func innerShadowConfiguration(_ configuration: ShadowConfiguration) -> some ShapeStyle {
...
extension NSShadow {
    ...
    public convenience init(configuration: ShadowConfiguration) {
        self.init()
        configurate(using: configuration)
    }

    /// Configurates the shadow.
    public func configurate(using configuration: ShadowConfiguration) {
...
extension NSUIView {
    ...
    public func configurate(using configuration: ShadowConfiguration, type: ShadowConfiguration.ShadowType) {
        if type == .outer {
