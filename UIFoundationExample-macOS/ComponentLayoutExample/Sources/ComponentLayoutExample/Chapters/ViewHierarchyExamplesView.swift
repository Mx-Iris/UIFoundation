...
final class ViewHierarchyExamplesView: ChapterView {
    @Observable
    class ViewModel {
    ...
    override func updateProperties() {
        ...
        componentEngine.component = VStack(spacing: 40) {
            ...
            VStack(spacing: 10) {
                Text("How UIFoundationComponent creates views", font: .subtitle)
                VStack(spacing: 8) {
            ...
            VStack(spacing: 10) {
                ...
                Text("When you apply view properties like backgroundColor or cornerRadius to a layout component, UIFoundationComponent creates a NSView for that layout. However, this view is placed underneath the children as a sibling, not as a parent.", font: .body).textColor(.secondaryLabel)
                ...
                VStack(spacing: 15) {
                    VStack(spacing: 6) {
                        ...
                        Code {
                            """
                            // View Hierarchy:
                            // ↳ NSView(backgroundColor: .systemBlue, cornerRadius: 12)
                            // ↳ UILabel(text: "Hello")
                            // ↳ UILabel(text: "World")
                            //
                ...
                VStack(spacing: 15) {
                    VStack(spacing: 6) {
                        ...
                        Code {
                            """
                            // View Hierarchy:
                            // ↳ NSScrollView(wrapping all content)
                            //   ↳ UILabel(text: "Item 1")
                            //   ↳ UILabel(text: "Item 2")
                            //   ↳ ...
                            """
                ...
                VStack(spacing: 15) {
                    VStack(spacing: 6) {
                        ...
                        Code {
                            ...
                            // View Hierarchy:
                            // ↳ NSView(backgroundColor: .systemBlue, Spacious - 10pt larger than UILabel)
                ...
                VStack(spacing: 15) {
                    VStack(spacing: 6) {
                        ...
                        Code {
                            """
                            // View Hierarchy:
                            // ↳ NSView(shadow properties)
                            //   ↳ NSView(background, cornerRadius, clipsToBounds)
                            //     ↳ NSView(background: .systemBlue.withAlphaComponent(0.1))
                ...
                VStack(spacing: 15) {
                    VStack(spacing: 6) {
                        ...
                        Code {
                            ...
                            // ↳ NSView(cornerRadius, clipsToBounds) - sibling
                            // ↳ NSView(blue) - sibling, not clipped
                            """
                        }
                    }
                    ...
                    VStack(spacing: 6) {
                        ...
                        Code {
                            ...
                            // ↳ NSView(cornerRadius, clipsToBounds) - parent
                            //   ↳ NSView(blue) - child, gets clipped
                            """
                        }
                    }
                }
