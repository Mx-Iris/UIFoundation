...
final class SizingAndConstraintExamplesView: ChapterView {
    override func updateProperties() {
        ...
        componentEngine.component = VStack(spacing: 40) {
            ...
            VStack(spacing: 10) {
                ...
                Text("UIFoundationComponent provides powerful sizing modifiers to control component dimensions. Understanding these modifiers is essential for building responsive layouts.", font: .body).textColor(.secondaryLabel)
                VStack(spacing: 8) {
            ...
            VStack(spacing: 10) {
                ...
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 10) {
                        ...
                        #CodeExample(
                            VStack {
                                Image(systemName: "photo", withConfiguration: NSImage.SymbolConfiguration(pointSize: 40, weight: .regular))
