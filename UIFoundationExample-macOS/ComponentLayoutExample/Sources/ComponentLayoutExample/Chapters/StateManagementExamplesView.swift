...
final class StateManagementExamplesView: ChapterView {
    @Observable
    class ViewModel {
    ...
    override func updateProperties() {
        ...
        componentEngine.component = VStack(spacing: 40) {
            ...
            VStack(spacing: 10) {
                ...
                Text("State management in UIFoundationComponent refers to how you handle dynamic data that changes over time and triggers UI updates. UIFoundationComponent supports multiple patterns for managing state.", font: .body).textColor(.secondaryLabel)
                VStack(spacing: 8) {
                ...
                VStack(spacing: 15) {
                    ...
                    VStack(spacing: 6, alignItems: .start) {
                        ...
                        VStack(spacing: 8, alignItems: .start) {
                            ...
                            VStack(spacing: 4, alignItems: .start) {
                                Text("3. NSView integration", font: .bodyBold)
                                Text("NSView's updateProperties() implementation automatically observes @Observable objects, calling setNeedsUpdateProperties() when they change.", font: .body).textColor(.secondaryLabel)
                            }
...
@available(macOS 14.0, *)
@GenerateCode
final class ManualCounterExample: NSView {
    var count: Int = 0 {
        didSet {
...
@available(macOS 14.0, *)
@GenerateCode
final class AutoCounterExample: NSView {
    @Observable
    class ViewModel {
        var count: Int = 0
    }
...
@available(macOS 14.0, *)
@GenerateCode
final class ComplexListExample: NSView {
    @Observable
    class ViewModel {
        var items: [ItemModel] = [
            ItemModel(id: UUID(), title: "Learn UIFoundationComponent"),
