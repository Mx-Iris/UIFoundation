...
final class StackExamplesView: ChapterView {
    override func updateProperties() {
        ...
        componentEngine.component = VStack(spacing: 40) {
            ...
            VStack(spacing: 10) {
                ...
                #CodeExample(
                    HStack(spacing: 10, alignItems: .center) {
                        Image(systemName: "person.circle.fill", withConfiguration: NSImage.SymbolConfiguration(pointSize: 30, weight: .regular)).tintColor(.systemBlue)
                        VStack(spacing: 4) {
