...
@available(macOS 14.0, *)
final class FlowExamplesView: ChapterView {
    ...
    override func updateProperties() {
        ...
        componentEngine.component = VStack(spacing: 40) {
            ...
            VStack(spacing: 10) {
                ...
                #CodeExample(
                    Flow(spacing: 10) {
                        for color in [NSColor.systemRed, .systemOrange, .systemYellow, .systemGreen, .systemMint, .systemTeal, .systemCyan, .systemBlue, .systemIndigo, .systemPurple, .systemPink, .systemBrown] {
...
@available(macOS 14.0, *)
@GenerateCode
final class FilterChipsExampleView: NSView {
    @Observable
