...
final class SimpleExamplesView: ChapterView {
    @Observable
    ...
    override func updateProperties() {
        ...
        componentEngine.component = VStack(spacing: 40) {
            ...
            VStack(spacing: 10) {
                Text("Basic UIFoundationComponent hierarchy", font: .subtitle)
                Text("Similar to SwiftUI, UIFoundationComponent can be constructed using declarative syntax. Here is a simple example using VStack, Image, and Text", font: .body).textColor(.secondaryLabel)
                #CodeExample(
                    VStack {
            ...
            VStack(spacing: 10) {
                ...
                Text("To render components on screen, assign the component to any NSView's componentEngine.component", font: .body).textColor(.secondaryLabel)
                Code {
                    """
