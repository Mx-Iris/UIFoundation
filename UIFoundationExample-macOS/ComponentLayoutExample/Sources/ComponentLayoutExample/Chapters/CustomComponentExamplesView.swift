...
final class CustomComponentExamplesView: ChapterView {
    @Observable
    class ViewModel {
            ...
            VStack(spacing: 10) {
                ...
                VStack(spacing: 15) {
                    ...
                    VStack(spacing: 6) {
                        ...
                        Text("UIFoundationComponent provides additional type erasure methods for different use cases:", font: .body).textColor(.secondaryLabel)
            ...
            VStack(spacing: 10) {
                ...
                VStack(spacing: 15) {
                    ...
                    VStack(spacing: 6) {
                        ...
                        Text("UIFoundationComponent provides several RenderNode types optimized for different layouts:", font: .body).textColor(.secondaryLabel)
                ...
                VStack(spacing: 12) {
                    ...
                    HStack(spacing: 10) {
                        ...
                        VStack(spacing: 4) {
                            ...
                            Text("Components should be value types (structs). This ensures they're thread-safe and work well with UIFoundationComponent's architecture.", font: .body).textColor(.secondaryLabel)
                        }.flex()
                    }
...
struct UserCard: ComponentBuilder {
    ...
    func build() -> some Component {
        HStack(spacing: 12, alignItems: .center) {
            Image(systemName: "person.circle.fill", withConfiguration: NSImage.SymbolConfiguration(pointSize: 40, weight: .regular))
                .tintColor(.systemBlue)
...
struct Avatar: ComponentBuilder {
    ...
    func build() -> some Component {
        Image(systemName: systemImage, withConfiguration: NSImage.SymbolConfiguration(pointSize: size * 0.5, weight: .regular))
            .tintColor(.white)
            .contentMode(.center)
...
struct ListRow: ComponentBuilder {
    ...
    var title: String
    var subtitle: String
    var iconColor: NSColor = .systemBlue
    ...
    func layout(_ constraint: Constraint) -> some RenderNode {
        ...
        if isCompact {
            ...
            return VStack(spacing: 12, alignItems: .center) {
                Image(systemName: icon, withConfiguration: NSImage.SymbolConfiguration(pointSize: 40, weight: .regular))
                    .tintColor(.systemBlue)
            ...
            return HStack(spacing: 16, alignItems: .center) {
                Image(systemName: icon, withConfiguration: NSImage.SymbolConfiguration(pointSize: 50, weight: .regular))
                    .tintColor(.systemBlue)
