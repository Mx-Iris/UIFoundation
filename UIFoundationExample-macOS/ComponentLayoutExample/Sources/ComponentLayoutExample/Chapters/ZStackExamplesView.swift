...
final class ZStackExamplesView: ChapterView {
        ...
        componentEngine.component = VStack(spacing: 40) {
            ...
            VStack(spacing: 10) {
                ...
                VStack(spacing: 10) {
                    ...
                    #CodeExample(
                        ZStack(verticalAlignment: .start, horizontalAlignment: .end) {
                            Image(systemName: "bell.fill", withConfiguration: NSImage.SymbolConfiguration(pointSize: 40, weight: .regular)).tintColor(.label)
                    ...
                    #CodeExampleNoInsets(
                        ZStack {
                            ...
                            VStack(spacing: 10) {
                                Image(systemName: "arrow.clockwise", withConfiguration: NSImage.SymbolConfiguration(pointSize: 20, weight: .regular)).tintColor(.white)
                    ...
                    #CodeExampleNoInsets(
                        ZStack {
                            Image(systemName: "sparkles", withConfiguration: NSImage.SymbolConfiguration(pointSize: 80, weight: .regular)).tintColor(.systemYellow).offset(x: -30, y: -20)
