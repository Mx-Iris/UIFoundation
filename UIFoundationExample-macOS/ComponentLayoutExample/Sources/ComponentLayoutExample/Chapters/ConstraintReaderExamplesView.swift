...
final class ConstraintReaderExamplesView: ChapterView {
    @Observable
    class ViewModel {
                        ...
                        ConstraintReader { constraint in
                            HStack {
                                ...
                                VStack(spacing: 12, justifyContent: .center, alignItems: .center) {
                                    Image(systemName: "star.fill", withConfiguration: NSImage.SymbolConfiguration(pointSize: 40, weight: .regular))
                                ...
                                // Page 2
                                VStack(spacing: 12, justifyContent: .center, alignItems: .center) {
                                    Image(systemName: "heart.fill", withConfiguration: NSImage.SymbolConfiguration(pointSize: 40, weight: .regular))
                                ...
                                // Page 3
                                VStack(spacing: 12, justifyContent: .center, alignItems: .center) {
                                    Image(systemName: "checkmark.circle.fill", withConfiguration: NSImage.SymbolConfiguration(pointSize: 40, weight: .regular))
                                        .tintColor(.systemGreen)
                            ...
                            .scrollView()
                            // `UIScrollView.isPagingEnabled` has no AppKit
                            // counterpart -- NSScrollView does not page. The
                            // pages still read as pages because ConstraintReader
                            // sizes each one to the viewport; only the snapping
                            // is missing.
            ...
            VStack(spacing: 10) {
                ...
                VStack(spacing: 10) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("This applies to all escaping closures in UIFoundationComponent, not just ConstraintReader!", font: .body).textColor(.secondaryLabel)
